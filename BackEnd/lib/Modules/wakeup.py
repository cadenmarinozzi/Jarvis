...
import requests, json, random, math, base64
...
def wakeup(textToSpeech, phrases):
    ...
    speechString = "Good morning. The date is " + date + ". " + answerNow + " " + time + " and Ethereum is at " + str(math.floor(price)) + " dollars, " + (lastPrice == "" and "" or (str(math.floor(abs(priceDelta))) + " dollars " + (priceDelta > 0 and "more" or "less") + " than yesterday."));
